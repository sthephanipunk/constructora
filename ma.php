    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header">Materiales</h1></center>
...
<h2>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  Eliminar Material
    ...
    <div class="col-xs-4">
     <label for="exampleInputEmail1">ingrese Id o nombre de Material</label>
     <input type="text" class="form-control" name="TXT_Matricula" placeholder="Id o nombre..." size="15%">
   </div>
   <div class="col-xs-4">
     <label  for="exampleInputEmail1">ingrese Id de Material a eliminar</label>
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Nombre Material</label>
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Cantidad Material nuevo</label>
