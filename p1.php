...
<h2>
  ...
  Eliminar Usuario
    ...
    <div class="col-xs-4">
     ...
     <input type="text" class="form-control" name="TXT_Matricula" placeholder="Id, nombre..." size="15%">
   </div>
   <div class="col-xs-4">
...
if(isset($_POST['TXT_Matricula'])){
      ...
      <th><center>contraseña Administrador</center></th>
          ...
          { 
             echo "<tr>";
             print('<td ><center><input size="10" name="TXT_Matricula" type="text" id="TXT_Matricula" value="'.$row['id_responsable_obra'].'" /></center></td>');
                
               print('<td><center><input size="10" name="TXT_Nombre" type="text" id="TXT_Nombre" value="'.$row['nombre'].'"/></center></td>');

               print('<td ><center><input size="10" name="TXT_A_Paterno" type="text" id="TXT_A_Paterno" value="'.$row['apellido_paterno'].'"/></center></td>');
              
               print('<td><center><input size="10" name="TXT_A_Materno" type="text" id="TXT_A_Materno" value="'.$row['apellido_materno'].'"/></center></td>'); 


               print('<td><center><input size="10" name="Contra" type="text" id="Contra" value="'.$row['contra'].'"/></center></td>'); 


               print('<td><center><input size="10" name="Contra_admin" type="text" id="Contra_admin" value="'.$row['contra_admin'].'"/></center></td>');
                echo "</tr>"; 
          }
          echo "</table>";
