    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header">Bodega</h1></center>
...
<h2>
  ...
  Eliminar Bodega
    ...
    <div class="col-xs-4">
     <label for="exampleInputEmail1">ingrese Id o nombre de Bodega a actualizar</label>
     <input type="text" class="form-control" name="TXT_Matricula" placeholder="Id, nombre o apellidos..." size="15%">
   </div>
   <div class="col-xs-4">
     <label  for="exampleInputEmail1">ingrese id de Bodega a eliminar</label>
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Nombre Bodega</label>
 ...
 <div class="col-xs-4">
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Entrada</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div>  
<div class="col-xs-4">
    <label for="exampleInputPassword1">Id Salida</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div>  
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Bodega</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div>  
<div class="col-xs-4">
    <label for="exampleInputPassword1">Id Bodega</label>
  ...
  <div class="col-xs-4">
    ...
    <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Exedente</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div>  
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Obra</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div> 
   ...
   <br>
    ...
    <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Responsable</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
  </div>  
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Responsable</label>
  ...
  <div class="col-xs-4">
    ...
    <input type="text" class="form-control" name="contra_usuario" placeholder="cantidad...">
    </div>
    <div class="col-xs-4">
    <label for="exampleInputPassword1">Cantidad</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="cantidad...">
  ...
  <div class="col-xs-4">
   ...
   <div class="col-xs-4"></div>
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Tipo de Unidad</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="Id...">
    </div>
    <div class="col-xs-4">
    <label for="exampleInputPassword1">Id Tipo de Unidad</label>
  ...
  <div class="col-xs-4">
    ...
    <input type="text" class="form-control" name="contra_usuario" placeholder="ejem 2000/12/24...">
    </div>
    <div class="col-xs-4">
    <label for="exampleInputPassword1">Fecha</label>
    <input type="text" class="form-control" name="contra_usuario" placeholder="ejem 2000/12/24...">
   ...
   <br>
    <div>
    <button style="left:47%" type="submit" name="btn" class="btn btn-success col-xs-1" >Entrada</button>
  </div>
  <button style="left:72%" type="submit" name="btn" class="btn btn-success col-xs-1" >Salida</button>
  </div>
   <br>
   <br>
   <br>
   <br>
   <button style="left:20%" type="submit" name="btn" class="btn btn-primary col-xs-1" >Bodegas</button>
   <button style="left:25%" type="submit" name="btn" class="btn btn-primary col-xs-1" >Entradas</button>
   <button style="left:30%" type="submit" name="btn" class="btn btn-primary col-xs-1" >Salidas</button>
