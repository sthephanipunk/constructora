    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <center><h1 class="page-header">Herramientas</h1></center>
...
<h2>
 &nbsp;&nbsp;&nbsp;
  ...
  Eliminar Herramienta
    ...
    <div class="col-xs-4">
     <label  for="exampleInputEmail1">Id Herramienta...</label>
     <input  type="text" class="form-control" name="id" placeholder="Id..." size="15%">
   </div>
    <div class="col-xs-4">
     <label for="exampleInputEmail1">ingrese Id o nombre de Herramienta</label>
     <input type="text" class="form-control" name="TXT_Matricula" placeholder="Id o nombre..." size="15%">
   </div>
   <div class="col-xs-4">
     <label  for="exampleInputEmail1">ingrese Id de Herramienta a eliminar</label>
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Nombre Herramienta</label>
  ...
  <div class="col-xs-4">
    <label for="exampleInputPassword1">Cantidad Herramienta nueva</label>
    <input type="text" class="form-control" name="apellido_paterno" placeholder="cantidad...">
  </div>
